...
func (mg *CustomPolicy) GetTerraformResourceType() string {
	return "cloudinaryprovisioning_custom_policy"
}
...
// GetInitParameters of this CustomPolicy
func (tr *CustomPolicy) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this CustomPolicy
func (tr *CustomPolicy) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
